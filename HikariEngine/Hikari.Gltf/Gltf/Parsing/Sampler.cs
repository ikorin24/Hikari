...
internal enum SamplerMinFilter
{
    ...
    Linear,
    /// <summary>nearest and mipmap is nearest</summary>
    NearestMipmapNearest,
    /// <summary>linear and mipmap is nearest</summary>
    LinearMipmapNearest,
    /// <summary>nearest and mipmap is linear</summary>
    NearestMipmapLinear,
    /// <summary>linear and mipmap is linear</summary>
    LinearMipmapLinear,
}
