...
namespace Hikari
{
    ...
    public struct Matrix3 : IEquatable<Matrix3>
    {
        ...
        {
            return Unsafe.As<float, Vector3>(ref Unsafe.AsRef(in matrix.M00)) * vec.X +
                   Unsafe.As<float, Vector3>(ref Unsafe.AsRef(in matrix.M01)) * vec.Y +
                   Unsafe.As<float, Vector3>(ref Unsafe.AsRef(in matrix.M02)) * vec.Z;
