...
{
    [EnumMapTo(Wgpu.VertexFormat.Uint8)] Uint8 = 0,
    [EnumMapTo(Wgpu.VertexFormat.Uint8x2)] Uint8x2 = 1,
    [EnumMapTo(Wgpu.VertexFormat.Uint8x4)] Uint8x4 = 2,
    [EnumMapTo(Wgpu.VertexFormat.Sint8)] Sint8 = 3,
    [EnumMapTo(Wgpu.VertexFormat.Sint8x2)] Sint8x2 = 4,
    [EnumMapTo(Wgpu.VertexFormat.Sint8x4)] Sint8x4 = 5,
    [EnumMapTo(Wgpu.VertexFormat.Unorm8)] Unorm8 = 6,
    [EnumMapTo(Wgpu.VertexFormat.Unorm8x2)] Unorm8x2 = 7,
    [EnumMapTo(Wgpu.VertexFormat.Unorm8x4)] Unorm8x4 = 8,
    [EnumMapTo(Wgpu.VertexFormat.Snorm8)] Snorm8 = 9,
    [EnumMapTo(Wgpu.VertexFormat.Snorm8x2)] Snorm8x2 = 10,
    [EnumMapTo(Wgpu.VertexFormat.Snorm8x4)] Snorm8x4 = 11,
    [EnumMapTo(Wgpu.VertexFormat.Uint16)] Uint16 = 12,
    [EnumMapTo(Wgpu.VertexFormat.Uint16x2)] Uint16x2 = 13,
    [EnumMapTo(Wgpu.VertexFormat.Uint16x4)] Uint16x4 = 14,
    [EnumMapTo(Wgpu.VertexFormat.Sint16)] Sint16 = 15,
    [EnumMapTo(Wgpu.VertexFormat.Sint16x2)] Sint16x2 = 16,
    [EnumMapTo(Wgpu.VertexFormat.Sint16x4)] Sint16x4 = 17,
    [EnumMapTo(Wgpu.VertexFormat.Unorm16)] Unorm16 = 18,
    [EnumMapTo(Wgpu.VertexFormat.Unorm16x2)] Unorm16x2 = 19,
    [EnumMapTo(Wgpu.VertexFormat.Unorm16x4)] Unorm16x4 = 20,
    [EnumMapTo(Wgpu.VertexFormat.Snorm16)] Snorm16 = 21,
    [EnumMapTo(Wgpu.VertexFormat.Snorm16x2)] Snorm16x2 = 22,
    [EnumMapTo(Wgpu.VertexFormat.Snorm16x4)] Snorm16x4 = 23,
    [EnumMapTo(Wgpu.VertexFormat.Float16)] Float16 = 24,
    [EnumMapTo(Wgpu.VertexFormat.Float16x2)] Float16x2 = 25,
    [EnumMapTo(Wgpu.VertexFormat.Float16x4)] Float16x4 = 26,
    [EnumMapTo(Wgpu.VertexFormat.Float32)] Float32 = 27,
    [EnumMapTo(Wgpu.VertexFormat.Float32x2)] Float32x2 = 28,
    [EnumMapTo(Wgpu.VertexFormat.Float32x3)] Float32x3 = 29,
    [EnumMapTo(Wgpu.VertexFormat.Float32x4)] Float32x4 = 30,
    [EnumMapTo(Wgpu.VertexFormat.Uint32)] Uint32 = 31,
    [EnumMapTo(Wgpu.VertexFormat.Uint32x2)] Uint32x2 = 32,
    [EnumMapTo(Wgpu.VertexFormat.Uint32x3)] Uint32x3 = 33,
    [EnumMapTo(Wgpu.VertexFormat.Uint32x4)] Uint32x4 = 34,
    [EnumMapTo(Wgpu.VertexFormat.Sint32)] Sint32 = 35,
    [EnumMapTo(Wgpu.VertexFormat.Sint32x2)] Sint32x2 = 36,
    [EnumMapTo(Wgpu.VertexFormat.Sint32x3)] Sint32x3 = 37,
    [EnumMapTo(Wgpu.VertexFormat.Sint32x4)] Sint32x4 = 38,
    [EnumMapTo(Wgpu.VertexFormat.Float64)] Float64 = 39,
    [EnumMapTo(Wgpu.VertexFormat.Float64x2)] Float64x2 = 40,
    [EnumMapTo(Wgpu.VertexFormat.Float64x3)] Float64x3 = 41,
    [EnumMapTo(Wgpu.VertexFormat.Float64x4)] Float64x4 = 42,
}
