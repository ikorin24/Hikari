...
internal readonly struct U8String : IEquatable<U8String>
{
    ...
    public bool SequenceEqual(ReadOnlySpan<byte> other) => _bytes.AsSpan().SequenceEqual(other);
    ...
    public override bool Equals(object? obj) => obj is U8String @string && Equals(@string);

    public bool Equals(U8String other) => _bytes.AsSpan().SequenceEqual(other.AsSpan());
    ...
    public static bool operator ==(U8String left, ReadOnlySpan<byte> right) => left.SequenceEqual(right);
    public static bool operator !=(U8String left, ReadOnlySpan<byte> right) => !(left == right);

    public static bool operator ==(ReadOnlySpan<byte> left, U8String right) => right.SequenceEqual(left);
